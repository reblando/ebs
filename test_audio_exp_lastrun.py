...
expName = 'test_audio_exp'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alexreblando/Desktop/ebs/test_audio_exp_lastrun.py',
...
image = visual.ImageStim(
    win=win, name='image',
    image='storypics/11_storypic.jpg', mask=None,
