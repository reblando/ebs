...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alexreblando/Library/Mobile Documents/com~apple~CloudDocs/Documents/GitHub/ebs/test2_lastrun.py',
...
for trial in range (len(color)):
    print("color = {}, text = {}".format(color[trial], text[trial]))
