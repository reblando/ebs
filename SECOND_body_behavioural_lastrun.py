...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alexreblando/Documents/GitHub/ebs/SECOND_body_behavioural_lastrun.py',
...
order_stories = np.array([14,43,23,34,31,11,42,22])
