...
expName = 'body_behavioural_mayedit'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alexreblando/Documents/GitHub/ebs/body_behavioural_mayedit_lastrun.py',
...
for thisTrial_6 in trials_6:
    ...
    if value < .5:
        ...
        if this_perspective == 'Couples Therapist':
            ...
            question1 = 'For how long has the initiator of the break up been thinking about breaking up with their partner?'
            question2 ='What is the initial reason stated by the initiator for why they are breaking up?'
            question3 ='Does the person who is being broken up with want to break up and what’s the reason stated by the person being broken up with that they do or do not want to break up?'
        ...
        if this_perspective == 'Airport Customer Experience Manager':
            ...
            question2 ='What do the clients have to do to comply with security before being scanned in the metal detector?'
            question3 ='Toward which gate are the clients walking?'
            question4 ='In what section and seat does each client sit on the plane?' 
        if this_perspective == 'Grocery Store Customer Experience Manager':
            pic1 = 'jobphotos/gscem.jpg'
            question1 = 'What is the grocery store like upon entering?'
            question2 ='What items do the clients pick out?'
            question3 ='How many checkout lanes are open and which one do they step into?'
            question4 = 'How much are the groceries and what method of payment do the clients use?'
        if this_perspective == 'Dean of Academic Studies':
            ...
            question2 ='What class are the students  in and what is the day’s lecture about?'
            question3 ='What is something taught in lecture?'
            question4 = 'What is the next assessment in class and when is it due/scheduled?'
        if this_perspective == 'Wedding Planner':
            pic1 = 'jobphotos/weddingplanner.jpg'
            question1 = 'For how many years has the couple been dating?'
            question2 ='How many diamonds are on the ring and what is the color?'
        ...
        if this_perspective == 'Matchmaker':
            ...
            question1 = 'What object is the initiator holding when he first notices the other person?' 
            question2 ='What is the initial question that begins the conversation between the couple?'
            question3 ='When will be the next time the couple meet and for what occasion?'
            question4 = 'What time is it when they part?'
    
        if other_perspective == 'Couples Therapist':
            pic2 = 'jobphotos/couples.jpg'
            question5 = 'For how long has the initiator of the break up been thinking about breaking up with their partner?'
            question6 ='What is the initial reason stated by the initiator for why they are breaking up?'
            question7 ='Does the person who is being broken up with want to break up and what’s the reason stated by the person being broken up with that they do or do not want to break up?'
        ...
        if other_perspective == 'Airport Customer Experience Manager':
            ...
            question6 ='What do the clients have to do to comply with security before being scanned in the metal detector?'
            question7 ='Toward which gate are the clients walking?'
            question8 ='In what section and seat does each client sit on the plane?' 
        if other_perspective == 'Grocery Store Customer Experience Manager':
            ...
            question7 ='How many checkout lanes are open and which one do they step into?'
        ...
        if other_perspective == 'Dean of Academic Studies':
            ...
            question8 = 'What is the next assessment in class and when is it due/scheduled?'
        if other_perspective == 'Wedding Planner':
            ...
            question6 ='How many diamonds are on the ring and what is the color?'
        ...
        if other_perspective == 'Matchmaker':
            ...
            question5 = 'What object is the initiator holding when he first notices the other person?' 
            question6 ='What is the initial question that begins the conversation between the couple?'
            question7 ='When will be the next time the couple meet and for what occasion?'
            question8 = 'What time is it when they part?'
    else:
