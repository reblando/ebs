...
order_stories = np.array([21,34,12,44,43,11,33,22])
order_perspectives = np.array(['Location','Location','Location','Social','Location','Social','Social','Social'])
