...
expName = 'testtimer'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alexreblando/Documents/GitHub/ebs/testtimer_lastrun.py',
...
countdownClock = core.CountdownTimer(100) # 100 s = 5 minutes 
countdownStarted = True 
timeText = '6:00'
# keep track of which components have finished
trialComponents = [image, key_resp_2, text]
