...
order_stories = np.array([32,23,33,11,14,44,41,22])
order_perspectives = np.array(['Social','Social','Location','Location','Social','Location','Social','Location'])
