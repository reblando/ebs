...
text_50 = visual.TextStim(win=win, name='text_50',
    text='When you are ready, press the space bar to begin reading the story. ',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
sound_1.setVolume(1)
couples_image = visual.ImageStim(
    win=win, name='couples_image',
    image='sin', mask=None,
...
for thisTrial in trials:
    ...
    for thisTrial_2 in trials_2:
        ...
        couples_image.setImage(this_story_pic)
        
        # keep track of which components have finished
        play_audio_storyComponents = [sound_1, couples_image]
        ...
        while continueRoutine:
            ...
            # *couples_image* updates
            if t >= 0.0 and couples_image.status == NOT_STARTED:
                # keep track of start time/frame for later
                couples_image.tStart = t
                couples_image.frameNStart = frameN  # exact frame index
                couples_image.setAutoDraw(True)
            for key in event.getKeys():
                if key in ['q']: 
                    trials.finished = 1
                    continueRoutine = False
