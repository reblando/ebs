...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alexreblando/Documents/GitHub/ebs/try1.py',
...
image_7 = visual.ImageStim(
    win=win, name='image_7',units='height', 
    image='/Users/alexreblando/Documents/GitHub/ebs/gscem.jpg', mask=None,
    ori=0, pos=(0, .1), size=(.5, .5),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
text_9 = visual.TextStim(win=win, name='text_9',
    text='Grocery Store Customer Experience Manager\n',
    font='Arial',
    pos=(0, -.5), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
# keep track of which components have finished
restaurant_criticComponents = [text_6, key_resp_8]
...
# keep track of which components have finished
Grocery_Store_Customer_Experience_ManagerComponents = [key_resp_11, image_7, text_9]
