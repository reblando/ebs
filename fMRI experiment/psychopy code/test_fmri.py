...
expName = 'test_fmri'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alexreblando/Desktop/ebs/fMRI experiment/psychopy code/test_fmri.py',
