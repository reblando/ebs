...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alexreblando/Documents/GitHub/ebs/fMRI experiment/psychopy code/test_fmri.py',
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
ravioliClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1
continueRoutine = True
...
while continueRoutine:
    ...
    tThisFlip = win.getFutureFlipTime(clock=ravioliClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
key_resp_3.rt = []
# keep track of which components have finished
audio_recordingComponents = [image_2, key_resp_3]
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
audio_recordingClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1
continueRoutine = True

# -------Run Routine "audio_recording"-------
while continueRoutine:
    # get current time
    t = audio_recordingClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=audio_recordingClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
