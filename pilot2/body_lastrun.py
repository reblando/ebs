...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alexreblando/Library/Mobile Documents/com~apple~CloudDocs/Documents/GitHub/ebs/body_lastrun.py',
...
for thisTrial in trials:
    ...
    if order_perspectives[count] == 'Social':
    ...
    this_story = storyDict.get(order_stories[count], {}).get('name')
